...
import { getCity, getState, getCreatepwd, getConfirmPwd, setRadioOrgCount } from "../actions";
        ...
        <div className="bg-white flex flex-col w-11/12">
          <div className="font-sans text-3xl p-4">
            <div className="flex justify-between my-4">
              <label className="text-blue-700 font-sans text-xl mb-2 w-5/12">State</label>
              <input
                type="text"
            ...
            <div className="flex justify-between my-4">
              <label className="text-blue-700 font-sans text-xl mb-2">City</label>
              <input
                type="text"
                className="border-2 border-gray-200 w-7/12 h-7 px-2 text-xl font-light"
                onChange={(e) => {
            ...
            <div className="flex justify-between ">
              <div className="flex justify-between my-2">
                <label className="text-blue-700 font-sans text-xl mb-2">How many users you have ?</label>
              </div>
              <div
                className="w-7/12"
                onChange={(e) => {
              ...
              >
                <input type="radio" id=">10" value=">10" name="org_count" className="mr-2" />
                <label htmlFor=">10" className="text-xl mr-2">
                  {">"}10
                </label>
                <input type="radio" id=">50" value=">50" name="org_count" className="mr-2" />
                <label htmlFor=">50" className="text-xl mr-2">
                  {">"}50
                </label>
                <input type="radio" id=">1000" value=">1000" name="org_count" className="mr-2" />
                <label htmlFor=">100" className="text-xl mr-2">
                  {">"}1000
                </label>
                <input type="radio" id="<100" value="<100" name="org_count" className="mr-2" />
                <label htmlFor="<100" className="text-xl mr-2">
                  {"<"}100
                </label>
              </div>
          ...
          <div className="pb-3 flex justify-center items-center">
            <button className=" BeforeSignUp-button  px-4 py-1  text-white no-underline" onClick={onClick_createAccount}>
              Create Org Account
            </button>
          </div>
        </div>
