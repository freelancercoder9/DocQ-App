    ...
    it("Should create user", (done) => {
      chai
        ...
        .end((err, res) => {
          ...
          expect(resBodyData).to.have.property("created_timestamp");
          expect(resBodyData).to.have.property("_id");
          expect(resBodyData).to.have.property("first_name");
          expect(resBodyData.first_name).to.equal("Chandu");
          done();
        });
    });
  });
