      ...
      <div className="col-span-2 flex flex-col justify-center items-center ">
        ...
        <div className="bg-white flex flex-col w-11/12">
          <div className="font-sans text-3xl p-4">
            ...
            <div className="flex justify-between my-4">
              <NavLink className="text-blue-700 font-mono text-xl mb-2 no-underline" to="/forgotPwd">
                Forgot Password ?
              </NavLink>
            </div>
          </div>
          <div className="pb-3 flex justify-center items-center">
            <NavLink className=" BeforeSignUp-button  px-4 py-1  text-white w-6/12 no-underline text-center" to="/dashboardScreen">
              Sign In
            </NavLink>
          </div>
          <div className="pb-3 flex justify-center items-center">
